...
document.write("<style>body{padding-top:2em;}#hacksmiths-banner{position:absolute;top:0;left:0;width:100%;background:#37474F;padding:0.5rem;}#hacksmiths-banner a{color:white !important; font-family:'Open Sans',sans-serif;text-decoration:none !important;margin-right:1em !important; border:none !important;}#hacksmiths-banner a:first-child{font-weight:bold;}@media screen and (max-width:800px){body{padding-top:0;} #hacksmiths-banner{display:none;}}</style>");
